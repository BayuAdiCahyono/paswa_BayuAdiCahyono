    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-secondary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="dashboard.php">
                <div class="sidebar-brand-text mx-3">DB PASWA<sup>2022</sup></div>
            </a>
            ...
            <li class="nav-item">
                <a class="nav-link" href="peserta_kelompok.php">
                    ...
                    <span>Data Peserta - Kelompk</span>
                </a>
            </li>           
        ...
        <ul class="navbar-nav ml-auto bg-light">
            ...
            <li class="nav-item dropdown no-arrow">
                <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                    data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <span class="mr-2 d-none d-lg-inline text-info bigh"><?php echo $_SESSION['valid']; ?></span>
