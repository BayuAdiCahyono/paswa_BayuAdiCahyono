...
<style>
    ...
    width: 100%;
    height: 100vh;
    background-image: linear-gradient( rgba(247, 223, 223, 0.507), rgba(233, 223, 223, 0.75)), url("gambar/cki.jpg");
                    ...
                    <div class="col-lg-12">
                        <div class="p-5">
                            <div class="text-center">
                                <h1 class="h4 text-primary mb-3">PENDAFTARAN PASWA</h1>
                            </div>
                            <form method="post" action="simpan_pendaftaran.php" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    <label>Alamat</label>
                                    <input maxlength="50" class="from-control" type="text" placeholder="Alamat" name="alamat">
                                </div>
                                ...
                                <hr>
                                <div class="text-center">
                                <a class="btn btn-success btn-user btn-block" href="index.php">Cencel</a>
                            </div>
                            </form>
                            <hr>
