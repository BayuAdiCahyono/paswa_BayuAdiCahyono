        ...
        <div class="card-body">
            <div class="table-responsive">
                <form method="POST" action="peserta_pro_edit.php">
                    ...
                    $id = $_GET['id'];
                    $result_data = mysqli_query($mysqli, "SELECT * FROM tab_peserta WHERE nim= '$id' ");
                    ...
                    <table>
                        ...
                        <div class="form-group row">
                            <div class="col-sm-4 mb-3 mb-sm-0">
                                ...
                                <select class="form-control form-control-user" Placeholder="Program Studi" name="prodi">
                                    ...
                                    <option value="TI" <?= $prodi == 'TI' ? 'selected' : '';?>>Teknik Informatika</option>
                        ...
                        <div class="form-group">
                            <label>Alamat</label>
                            <input maxlength="50" class="from-control" type="text" placeholder="Alamat" name="alamat" value="<?=$alamat;?>">
                        </div>
